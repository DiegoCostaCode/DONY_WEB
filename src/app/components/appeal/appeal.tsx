export default function Appel() {
    return (
        <section className="flex bg-[#070707] items-center justify-center">
            ...
            <div>
                <p className="text-h2  max-w-[1000px] leading-7">IF YOU WANT TO MAKE THE WORLD A BETTER PLACE,<br />
                    <span className="font-bold">TAKE A LOOK AT YOURSELF AND MAKE A CHANGE.</span>
                </p>
